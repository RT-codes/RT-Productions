...
export default function Footer() {
    ...
    return (
        <div id='contact' ref={ref} className='flex flex-col pt-16 pb-2 justify-center items-center gap-2 relative bottom-0 h-[15rem] w-[100%] m-0 bg-gray-200 bg-opacity-50 border-t-black/[0.03] border-2 mt-8 scroll-mt-28 mb-0'>
