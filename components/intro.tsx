  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      <motion.p className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-2xl" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ type: "spring", stiffness: 100, bounce: 0.25 }}>
        <span className="font-bold">Hello, Im Rowan.</span> Im a <span className="font-bold">full-stack developer</span> with <span className="font-bold">4 years</span> of experience. I enjoy <span className="italic">webdevelopment & software</span>.<br /> My focus is <span className="underline">React (Next.js), python and ai </span>.
      </motion.p>
